"""
Django settings for Ecom_Sys project.
...
import clothes.routers
import phones.routers
import carts.routers
import user.routers
...
SECRET_KEY = "django-insecure-)=b&u&)-p-625x#+j$^f7q(@)+(s)y(2#87%nyx)=!+k70#3+x"
...
WSGI_APPLICATION = "Ecom_Sys.wsgi.application"
